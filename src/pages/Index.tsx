...
const states = [
  {
    ...
    short: "AP",
    tag: "AP DSC",
    image: apScenicBanner,
    borderColor: "#f97316",
    btnGradient: "linear-gradient(135deg, #ea580c, #f97316)",
    btnShadow: "0 4px 16px rgba(249,115,22,0.6)",
  },
  {
    id: "ts",
    name: "Telangana",
    short: "TG",
    tag: "TS DSC",
    image: tsScenicBanner,
    borderColor: "#06b6d4",
    btnGradient: "linear-gradient(135deg, #0284c7, #06b6d4)",
    btnShadow: "0 4px 16px rgba(6,182,212,0.6)",
  },
];
